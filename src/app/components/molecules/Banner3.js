...
const Banner3 = () => {
  return (
    <div className="flex flex-col items-center rounded-lg bg-[url('/Clippathgroup.svg')] bg-no-repeat bg-cover p-5 ">
        <span className='font-bold text-2xl text-white'>How It All Works</span>
        <div className='grid lg:grid-cols-5 text-center gap-x-5 text-white'>
