...
const Functions3 = () => {
  return (
    <div className='flex flex-col items-center rounded-lg gap-1 lg:p-5 text-center p-3'>
      ...
      <span className='font-normal text-xs mt-5'>Why choose CBTProxy to secure your IT certification pass</span>
      <div className='text-black text-center grid grid-cols-1 lg:grid-cols-2 lg:gap-5 lg:mx-20'>
