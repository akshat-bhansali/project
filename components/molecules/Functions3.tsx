...
const Functions3 = (props:SecondaryFeaturesSection&{lang:string}) => {
  return (
    <div className='flex flex-col items-center rounded-lg gap-1 lg:p-5 text-center p-3 mt-10'>
      ...
      <div className='text-black text-center grid lg:grid-cols-2 grid-rows-5 lg:grid-rows-3 lg:gap-5 lg:mx-20 mb-20'>
